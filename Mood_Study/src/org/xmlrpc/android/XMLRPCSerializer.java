...
class XMLRPCSerializer implements IXMLRPCSerializer {
	...
	public void serialize(XmlSerializer serializer, Object object)
		...
		if (object instanceof Integer || object instanceof Short
			...
			/*
			 * System.out.println("** " + object.toString() + " is instance of "
			 * + object.getClass().getCanonicalName() + " **"); if(object==null)
			 * { System.out.println("Object is null."); } else {
			 * System.out.println("Object is not null."); if(((Object[])
			 * object).length==0) {
			 * System.out.println("Object has zero length."); } else {
